    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('blogs.update','test')}}" method="post" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row clearfix">
                                <div class="col">
                                    ...
                                    @if(isset($data->photo))
                                        <img src="{{asset('dash/blogs/' . $data->photo)}}" width="100px" height="100px" alt="">
                            ...
                            <div class="row">
                                <div class="col" style="text-align: center">
                                    ...
                                    <a href="{{route('blogs.index')}}" class="btn btn btn-info">الصفحه الرئسيه</a>
                                </div>
                            </div>
