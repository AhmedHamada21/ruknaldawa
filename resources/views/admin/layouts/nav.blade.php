    ...
    <div class="container-fluid px-0">
        ...
        <div id="navbar_main">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                {{--                    </form>--}}
                {{--                </li>--}}
                <li class="nav-item"><a class="nav-link nav-link-icon" href="{{route('home')}}" target="_blank"><i
                ...
                {{--                        <div class="py-3 px-3">--}}
                {{--                            <h5 class="heading h6 mb-0">Notifications <span class="badge badge-pill badge-primary text-uppercase float-left">3</span></h5>--}}
                {{--                        </div>--}}
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-left">
                        ...
                        {{--                        <a class="dropdown-item" href="javascript:void(0);"><span class="float-left badge badge-success">$50K</span><i class="fa fa-briefcase text-primary"></i>My Balance</a>--}}
                        {{--                        <a class="dropdown-item" href="javascript:void(0);"><span class="float-left badge badge-warning">4</span><i class="fa fa-envelope text-primary"></i>Inbox</a>--}}
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <a class="dropdown-item" :href="route('logout')"
                               onclick="event.preventDefault();
                                    ...
                                    class="fa fa-sign-out text-primary"></i>تسجيل الخروج</a>
