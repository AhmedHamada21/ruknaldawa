...
@section('navbar')
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="javascript:void(0);">سليدر</a>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                @foreach($data as $row)
                                    <tr>
                                        <td>{{$loop->index +1}}</td>
                                        <td><img src="{{asset('dash/slider/'.$row->photo)}}" width="50px" height="50px" alt=""></td>
                                        <td>{{$row->name}}</td>
                                        <td>
                                            <a href="{{route('sliders.edit',$row->id)}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
