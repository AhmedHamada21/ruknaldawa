                        ...
                        <form action="{{route('product.store')}}" method="post" autocomplete="off"
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="product_code" value="{{$code}}" class="form-control">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <!--    <input type="number" name="price_rali" required class="form-control">-->
                                <!--</div>-->
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <textarea class="summernote" name="notes" required rows="5"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <textarea class="summernote" name="info" required rows="5"></textarea>
                                </div>
                            </div>
...
{{--                                    <input type="text" class="form-control" id="tags" name="name_tage" data-role="tagsinput">--}}
{{--                                </div>--}}
{{--                            </div>--}}
